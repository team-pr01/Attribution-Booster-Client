        ...
        <div className="max-w-[85%] mx-auto">
          ...
          >
            ...
            <motion.p
              ...
              className="text-neutral-300 text-sm text-center lg:text-left lg:text-lg leading-6 lg:leading-[30px] font-Poppins max-w-[570px] 2xl:max-w-[750px] mt-3 lg:mt-0"
            >
