    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="text-neutral-300 text-sm lg:text-lg leading-6 lg:leading-[30px] font-Poppins max-w-[707px] mt-4 lg:mt-0"
        >
          At Attribution Booster, our team is your competitive edge. Each member
          brings deep expertise, relentless focus, and a results-driven mindset
          to transform your digital presence from code to conversions, campaigns
          to compliance.
        </motion.p>
      </motion.div>
