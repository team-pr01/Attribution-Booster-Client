...
const Hero = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="rounded-[20px] bg-[rgba(255,255,255,0.02)] border border-gray-700 backdrop-blur-[15px] relative overflow-hidden h-[850px] 2xl:h-[1080px]"
      ...
      >
        ...
        >
          ...
          >
            <Image src={IMAGES.circle} alt="" className="w-full h-full" />
          </motion.div>
        </motion.div>
