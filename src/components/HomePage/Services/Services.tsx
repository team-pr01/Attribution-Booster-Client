...
const Services = () => {
  const servicesData = [
  {
    ...
    description: "Our expert team manages all aspects of your email campaigns, from creating engaging content to analyzing campaign performance.",
  ...
  return (
    <div className="max-w-[1531px] mx-auto mt-[111px]">
      ...
      <p className="text-white text-lg leading-[30px] max-w-[430px]">
        Maximize Your Campaign’s Potential and Boost Your ROI with Our Advanced
